...
//console.log("[d]" + $(window).scrollTop());
...
//console.log("[e]" + $(window).scrollTop());
    ...
    return this.each(function () {
      ...
      function resizeHeight(iframe) {
		...
		// 20151123 sukenaga 津PC競技情報右側展示にてサイズが大きくならなかったため修正
		if( newHeight == 150 || newHeight == 151 ){
...
//ここでもうスクロール位置変更されないように
//console.log("[a]" + $(window).scrollTop());

		if( $(window).scrollTop() == 459 ){
...
//console.log("[f]" + $(window).scrollTop());
...
//console.log("スクロール記憶値" + intscroll);
...
//console.log("[g]" + $(window).scrollTop());

      } else {
        // For other browsers.
        $(this).load(function () {

//console.log("[c]" + $(window).scrollTop());
