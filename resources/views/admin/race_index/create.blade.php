...
@section('title', 'レースインデックス登録ページ 新規作成')

@section('content')

    <h1>レースインデックス登録ページ 新規作成</h1>
    <div style="margin:40px 0;">
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    {{ \Form::select('GRADE', $grade , old('GRADE') , ["class" => "form-control"]) }}
                </div>
            </div>
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <input type="text" class="form-control " name="PC_TENBO_URL" value="{{ old('PC_TENBO_URL') }}">
                </div>
            </div>
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <input type="text" class="form-control " name="SP_TENBO_URL" value="{{ old('SP_TENBO_URL') }}">
                </div>
            </div>
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <input type="text" class="form-control " name="PC_SYUTUJO_URL" value="{{ old('PC_SYUTUJO_URL') }}">
                </div>
            </div>
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <input type="text" class="form-control " name="SP_SYUTUJO_URL" value="{{ old('SP_SYUTUJO_URL') }}">
                </div>
            </div>
