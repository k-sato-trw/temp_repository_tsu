        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    ...
                    <div class="custom-control custom-radio" style="float: left; margin-right:20px;">
                        <input type="radio" id="id_TYPE_1" name="TYPE" class="custom-control-input" value="2" @if(old('TYPE') == "2") checked @endif >
                        <label class="custom-control-label" for="id_TYPE_1">お知らせ</label>
                    </div>
                    <div class="custom-control custom-radio" style="float: left; margin-right:20px;">
                        <input type="radio" id="id_TYPE_2" name="TYPE" class="custom-control-input" value="3" @if(old('TYPE') == "3") checked @endif >
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="id_MB_APPEAR_FLG" name="MB_APPEAR_FLG" value="1" @if(old('MB_APPEAR_FLG',false)) checked @endif >
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <input type="text" class="form-control " name="VIEW_DATE" value="{{ old('VIEW_DATE') }}">
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="id_NEW_FLG" name="NEW_FLG" value="1" @if(old('NEW_FLG',false)) checked @endif >
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <input type="text" class="form-control " name="HEADLINE_TITLE" value="{{ old('HEADLINE_TITLE') }}">
                </div>
            </div>
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="id_HEADLINE_FLG" name="HEADLINE_FLG" value="1" @if(old('HEADLINE_FLG',false)) checked @endif >
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <input type="text" class="form-control " name="PC_LINK" value="{{ old('PC_LINK') }}">
                </div>
            </div>
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="id_PC_LINK_WINDOW_FLG" name="PC_LINK_WINDOW_FLG" value="1" @if(old('PC_LINK_WINDOW_FLG',false)) checked @endif >
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <input type="text" class="form-control " name="SP_LINK" value="{{ old('SP_LINK') }}">
                </div>
            </div>
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="id_SP_LINK_WINDOW_FLG" name="SP_LINK_WINDOW_FLG" value="1" @if(old('SP_LINK_WINDOW_FLG',false)) checked @endif >
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <input type="text" class="form-control " name="MB_LINK" value="{{ old('MB_LINK') }}">
                </div>
            </div>
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="id_MB_LINK_WINDOW_FLG" name="MB_LINK_WINDOW_FLG" value="1" @if(old('MB_LINK_WINDOW_FLG',false)) checked @endif >
