    ...
    <div style="margin:40px 0;">
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <textarea class="form-control " name="HONBUN" id="HONBUN" rows="3">{{ old('HONBUN') }}</textarea>
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="id_PC_FLG" name="PC_FLG" value="1" @if(old('PC_FLG',false)) checked @endif >
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="id_SP_FLG" name="SP_FLG" value="1" @if(old('SP_FLG',false)) checked @endif >
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="id_MB_FLG" name="MB_FLG" value="1" @if(old('MB_FLG',false)) checked @endif >
