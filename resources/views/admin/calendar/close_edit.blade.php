...
@section('content')
    ...
    <h1>平和島 開催日付登録ページ</h1>
    <h2>入力モード:休館 ID:{{ $holdentry->ID }}</h2>
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <div class="custom-control custom-radio" style="float: left; margin-right:20px;">
                        <input type="radio" id="id_TYPE_0" name="TYPE" class="custom-control-input" value="1" @if(old('TYPE', $holdentry->TYPE) == "1") checked @endif >
                        <label class="custom-control-label" for="id_TYPE_0">本場</label>
                    </div>
                    <div class="custom-control custom-radio" style="float: left; margin-right:20px;">
                        <input type="radio" id="id_TYPE_1" name="TYPE" class="custom-control-input" value="3" @if(old('TYPE', $holdentry->TYPE) == "3") checked @endif >
                        <label class="custom-control-label" for="id_TYPE_1">本場内</label>
                    </div>
                    <div class="custom-control custom-radio" style="float: left; margin-right:20px;">
                        <input type="radio" id="id_TYPE_2" name="TYPE" class="custom-control-input" value="4" @if(old('TYPE', $holdentry->TYPE) == "4") checked @endif >
