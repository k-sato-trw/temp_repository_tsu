...
@section('content')
    ...
    <h1>津 開催日付登録ページ</h1>
    <h2>入力モード:外向け ID:{{ $holdentry->ID }}</h2>
    <div style="margin:40px 0;">
        <form method="post" enctype="multipart/form-data">

            <div class="card bg-secondary mb-3" >
                <div class="card-header">場</div>
                <div class="card-body">
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <input type="text" class="form-control " name="RACE_TITLE" value="{{ old('RACE_TITLE', $holdentry->RACE_TITLE) }}">
                </div>
            </div>
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <input type="text" class="form-control " name="CALENDAR_RACE_TITLE" value="{{ old('CALENDAR_RACE_TITLE', $holdentry->CALENDAR_RACE_TITLE) }}">
                </div>
            </div>
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <div class="custom-control custom-radio" style="float: left; margin-right:20px;">
                        <input type="radio" id="id_GRADE_0" name="GRADE" class="custom-control-input" value="0" @if(old('GRADE', $holdentry->GRADE) == "0") checked @endif >
                        <label class="custom-control-label" for="id_GRADE_0">SG</label>
                    </div>
                    <div class="custom-control custom-radio" style="float: left; margin-right:20px;">
                        <input type="radio" id="id_GRADE_1" name="GRADE" class="custom-control-input" value="1" @if(old('GRADE', $holdentry->GRADE) == "1") checked @endif >
                        <label class="custom-control-label" for="id_GRADE_1">G1</label>
                    </div>
                    <div class="custom-control custom-radio" style="float: left; margin-right:20px;">
                        <input type="radio" id="id_GRADE_2" name="GRADE" class="custom-control-input" value="2" @if(old('GRADE', $holdentry->GRADE) == "2") checked @endif >
                        <label class="custom-control-label" for="id_GRADE_2">G2</label>
                    </div>
                    <div class="custom-control custom-radio" style="float: left; margin-right:20px;">
                        <input type="radio" id="id_GRADE_3" name="GRADE" class="custom-control-input" value="3" @if(old('GRADE', $holdentry->GRADE) == "3") checked @endif >
                        <label class="custom-control-label" for="id_GRADE_3">G3</label>
                    </div>
                    <div class="custom-control custom-radio" style="float: left; margin-right:20px;">
                        <input type="radio" id="id_GRADE_4" name="GRADE" class="custom-control-input" value="4" @if(old('GRADE', $holdentry->GRADE) == "4") checked @endif >
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <div class="custom-control custom-radio" style="float: left; margin-right:20px;">
                        <input type="radio" id="id_RACE_TYPE_0" name="RACE_TYPE" class="custom-control-input" value="0" @if(old('RACE_TYPE', $holdentry->RACE_TYPE) == "0") checked @endif >
                        <label class="custom-control-label" for="id_RACE_TYPE_0">デイ</label>
                    </div>
                    <div class="custom-control custom-radio" style="float: left; margin-right:20px;">
                        <input type="radio" id="id_RACE_TYPE_1" name="RACE_TYPE" class="custom-control-input" value="1" @if(old('RACE_TYPE', $holdentry->RACE_TYPE) == "1") checked @endif >
                        <label class="custom-control-label" for="id_RACE_TYPE_1">ナイター</label>
                    </div>
                    <div class="custom-control custom-radio" style="float: left; margin-right:20px;">
                        <input type="radio" id="id_RACE_TYPE_2" name="RACE_TYPE" class="custom-control-input" value="2" @if(old('RACE_TYPE', $holdentry->RACE_TYPE) == "2") checked @endif >
            ...
            <div class="card bg-secondary mb-3" >
                ...
                <div class="card-body">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="id_LADY_FLG" name="LADY_FLG" value="1" @if(old('LADY_FLG', $holdentry->LADY_FLG)) checked @endif >
            ...
            <div class="card bg-secondary mb-3" >
                <div class="card-header">表示ライン</div>
                <div class="card-body">
                    {{ \Form::select('VIEW_LINE', $line_options , old('VIEW_LINE', $holdentry->VIEW_LINE) , ["class" => "form-control"]) }}
                </div>
            </div>
