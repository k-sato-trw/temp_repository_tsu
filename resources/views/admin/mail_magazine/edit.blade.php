...
@section('content')
    ...
    <form name="MailForm" method="post" >
        ...
        <div id="contents">
            ...
            <div id="main" class="page02">
                ...
                <div id="status" class="c{{$mail_magazine->SAVE_FLG}}">
                    [配信日時] <span>{{date('Y年n月j日',strtotime($mail_magazine->TARGET_DATE))}}({{ $week_label[date('w',strtotime($mail_magazine->TARGET_DATE))] }})</span>
                    @if($mail_magazine->SAVE_FLG == 1)
                        <div id="st">保存中</div>
                    @elseif($mail_magazine->SAVE_FLG == 2)
                        <div id="st">確定中</div>
                    @elseif($mail_magazine->SAVE_FLG == 3)
                        <div id="st">配信完了</div>
                    @endif
                ...
                <div id="mail_wrapper">
                        ...
                        <h4>サンプル</h4>
                            ...
                            <div id="mail_sample_main">
                                ...
                                <span>
                                    ...
                                    <br />
                                    【レース展望】<br />
                                    http://www.boatrace-tsu.com/asp/tsu/mailmagazine/tenbo_jumper.asp?ID={{$race_index->ID ?? ""}}<br />
                    ...
                    <div id="mail_form">
                        <div id="btn_all_delete"><a href="javascript:void(0);" onClick="if(confirm('現在のレコードを削除します。よろしいですか?')){location.href='/admin/mail_magazine/delete/{{$mail_magazine->TARGET_DATE}}/{{$mail_magazine->ID}}'}">× 削除</a></div><br/>
                        ...
                        <div class="box">
                            ...
                            <div class="box_sub">
                                <h5>序文</h5>
                                <textarea name="A_01" id="A_01" class="textarea" onKeyUp="A_WrapChange( 0 )" maxlength="2000">{{ old('A_01', $mail_magazine->SENSYU_INFO_PREFACE) }}</textarea>
                            </div>
                            ...
                            <div class="box_sub">
                                <h5>場内状況</h5>
                                <div class="box_no"><label>非掲載<input name="A_no3" id="A_no" class="checkbox" value="1" type="checkbox" onClick="C1_Disable();"  @if(old('A_no3', $mail_magazine->JONAI_FLG)) checked @endif></label></div>
                                ...
                                <ul id="C_01d">
                                    <li id="time">
                                        ...
                                        <td><input name="C_01_1" id="C_01_1" class="textbox" type="text" value="{{ old('C_01_1', $mail_magazine->OPEN_TIME) }}" onBlur="A_WrapChange( 0 );" maxlength="2">：<input name="C_01_2" id="C_01_2" class="textbox" type="text" value="{{ old('C_01_2', $mail_magazine->OPEN_TIME2) }}" onBlur="A_WrapChange( 0 );" maxlength="2">
                                        <label>　<span>節間、開門時間変更</span>
                                            <input name="time_no" id="time_no" class="checkbox" type="checkbox" value="1" onClick="C3_Disable();" @if(old('time_no', $mail_magazine->OPEN_TIME_FLG)) checked @endif>
                                        </label>
                                        </td>
                                        </tr>
                                        <tr id="C1_1_add">
                                        <td>1.<input name="C_01_3_1" class="textbox day" type="text" value="{{ old('C_01_3_1', $mail_magazine->OPEN_TIME_DATE1) }}" onBlur="A_WrapChange( 0 );" maxlength="11">
                                                <input name="C_01_4_1" id="C_01_4_1" class="textbox small" type="text" value="{{ old('C_01_4_1', $mail_magazine->OPEN_TIME11) }}" onBlur="A_WrapChange( 0 );" maxlength="2">：<input name="C_01_5_1" id="C_01_5_1" class="textbox small" type="text" onBlur="A_WrapChange( 0 );" value="{{ old('C_01_5_1', $mail_magazine->OPEN_TIME12) }}" maxlength="2"></td>
                                        </tr>
                                        <tr id="C1_2_add">
                                        <td>2.<input name="C_01_3_2" class="textbox day" type="text" value="{{ old('C_01_3_2', $mail_magazine->OPEN_TIME_DATE2) }}" onBlur="A_WrapChange( 0 );" maxlength="11">
                                                <input name="C_01_4_2" id="C_01_4_2" class="textbox small" type="text" value="{{ old('C_01_4_2', $mail_magazine->OPEN_TIME21) }}" onBlur="A_WrapChange( 0 );" maxlength="2">：<input name="C_01_5_2" id="C_01_5_2" class="textbox small" type="text" onBlur="A_WrapChange( 0 );" value="{{ old('C_01_5_2', $mail_magazine->OPEN_TIME22) }}" maxlength="2"></td>
                                        </tr>
                                        <tr id="C1_3_add">
                                        <td>3.<input name="C_01_3_3" class="textbox day" type="text" value="{{ old('C_01_3_3', $mail_magazine->OPEN_TIME_DATE3) }}" onBlur="A_WrapChange( 0 );" maxlength="11">
                                                <input name="C_01_4_3" id="C_01_4_3" class="textbox small" type="text" value="{{ old('C_01_4_3', $mail_magazine->OPEN_TIME31) }}" onBlur="A_WrapChange( 0 );" maxlength="2">：<input name="C_01_5_3" id="C_01_5_3" class="textbox small" type="text" onBlur="A_WrapChange( 0 );" value="{{ old('C_01_5_3', $mail_magazine->OPEN_TIME32) }}" maxlength="2"></td>
                                        </tr>
                                        <tr id="C1_4_add">
                                        <td>4.<input name="C_01_3_4" class="textbox day" type="text" value="{{ old('C_01_3_4', $mail_magazine->OPEN_TIME_DATE4) }}" onBlur="A_WrapChange( 0 );" maxlength="11">
                                                <input name="C_01_4_4" id="C_01_4_4" class="textbox small" type="text" value="{{ old('C_01_4_4', $mail_magazine->OPEN_TIME41) }}" onBlur="A_WrapChange( 0 );" maxlength="2">：<input name="C_01_5_4" id="C_01_5_4" class="textbox small" type="text" onBlur="A_WrapChange( 0 );" value="{{ old('C_01_5_4', $mail_magazine->OPEN_TIME42) }}" maxlength="2"></td>
                                        </tr>
                                        </table>
                                    ...
                                    <li>
                                        <dl>
                                            <dt>第1Rスタート展示</dt>
                                            <dd><input name="C_02_1" id="C_02_1" class="textbox" type="text" onBlur="A_WrapChange( 0 );" maxlength="2" value="{{ old('C_02_1', $mail_magazine->START_TIME) }}">：<input name="C_02_2" id="C_02_2" class="textbox" type="text" onBlur="A_WrapChange( 0 );" maxlength="2" value="{{ old('C_02_2', $mail_magazine->START_TIME2) }}"></dd>
                                        </dl>
                                    </li>
                                    <li>
                                        <dl>
                                            <dt>第12R本場締切予定</dt>
                                            <dd><input name="C_03_1" id="C_03_1" class="textbox" type="text" onBlur="A_WrapChange( 0 );" maxlength="2" value="{{ old('C_03_1', $mail_magazine->DEADLINE_TIME) }}">：<input name="C_03_2" id="C_03_2" class="textbox" type="text" onBlur="A_WrapChange( 0 );" maxlength="2" value="{{ old('C_03_2', $mail_magazine->DEADLINE_TIME2) }}"></dd>
                                        </dl>
                                    </li>
                                    <div class="clear"></div>
                                </ul>
    ...
    <div id="btn_reload"><a href="javascript:void(0);" onClick="SesnyuReload();">再読込</a></div>
                                <div class="box_no"><label>非掲載<input name="A_no1" id="A_no" class="checkbox" value="1" type="checkbox" onClick="A_Disable();" @if(old('A_no1', $mail_magazine->SENSYU_INFO_FLG)) checked @endif ></label></div>
                                                            
                                
                                <!--データ複製ここから-->
                                <dl id="A_02d">
                                    <dt>見出し</dt>
                                    <dd><input name="A_021" id="A_02" class="textbox" value="{{ old('A_021', $mail_magazine->SENSYU_INFO_TEXT1) }}" type="text" onKeyUp="A_WrapChange( 0 )" maxlength="512"></dd>
                                    <div class="clear"></div>
                                </dl>
                                ...
                                <dl id="A_03d">
                                    <dt>艇番表示</dt>
                                    <dd><input name="A_031" id="A_03" class="checkbox" value="1" type="checkbox" onClick="A_WrapChange( 0 );" @if(old('A_031', $mail_magazine->SENSYU_INFO_TEIBANFLG1)) checked @endif></dd>
                                </dl>
                                </label>
                                
                                <ul id="A_04d1" class="check A_04d">
                                    <li><dl><dt id="n11" class="n1">1号艇</dt><dd><input name="A_04_11" id="A_04_1" class="textbox" type="text" value="{{ old('A_04_11', $mail_magazine->SENSYU_INFO_TOUBAN11) }}" maxlength="4" onBlur="A_WrapChange( 11 )"></dd></dl></li>
                                    <li><dl><dt id="n12" class="n2">2号艇</dt><dd><input name="A_04_12" id="A_04_1" class="textbox" type="text" value="{{ old('A_04_12', $mail_magazine->SENSYU_INFO_TOUBAN12) }}" maxlength="4" onBlur="A_WrapChange( 12 )"></dd></dl></li>
                                    <li><dl><dt id="n13" class="n3">3号艇</dt><dd><input name="A_04_13" id="A_04_1" class="textbox" type="text" value="{{ old('A_04_13', $mail_magazine->SENSYU_INFO_TOUBAN13) }}" maxlength="4" onBlur="A_WrapChange( 13 )"></dd></dl></li>
                                    <li><dl><dt id="n14" class="n4">4号艇</dt><dd><input name="A_04_14" id="A_04_1" class="textbox" type="text" value="{{ old('A_04_14', $mail_magazine->SENSYU_INFO_TOUBAN14) }}" maxlength="4" onBlur="A_WrapChange( 14 )"></dd></dl></li>
                                    <li><dl><dt id="n15" class="n5">5号艇</dt><dd><input name="A_04_15" id="A_04_1" class="textbox" type="text" value="{{ old('A_04_15', $mail_magazine->SENSYU_INFO_TOUBAN15) }}" maxlength="4" onBlur="A_WrapChange( 15 )"></dd></dl></li>
                                    <li><dl><dt id="n16" class="n6">6号艇</dt><dd><input name="A_04_16" id="A_04_1" class="textbox" type="text" value="{{ old('A_04_16', $mail_magazine->SENSYU_INFO_TOUBAN16) }}" maxlength="4" onBlur="A_WrapChange( 16 )"></dd></dl></li>
                                    <div class="clear"></div>
                                </ul>
                                ...
                                <dl id="A_02d">
                                    <dt>見出し</dt>
                                    <dd><input name="A_022" id="A_02" class="textbox" value="{{ old('A_022', $mail_magazine->TEXT2) }}" type="text" onKeyUp="A_WrapChange( 0 )" maxlength="512"></dd>
                                    <div class="clear"></div>
                                </dl>
                                ...
                                <dl id="A_03d">
                                    <dt>艇番表示</dt>
                                    <dd><input name="A_032" id="A_03" class="checkbox" value="1" type="checkbox" onClick="A_WrapChange( 0 );"  @if(old('A_032', $mail_magazine->SENSYU_INFO_TEIBANFLG2)) checked @endif ></dd>
                                </dl>
                                </label>
                                
                                <ul id="A_04d2" class="check A_04d">
                                    <li><dl><dt id="n21" class="n1">1号艇</dt><dd><input name="A_04_21" id="A_04_1" class="textbox" type="text" value="{{ old('A_04_21', $mail_magazine->SENSYU_INFO_TOUBAN21) }}" maxlength="4" onBlur="A_WrapChange( 21 )"></dd></dl></li>
                                    <li><dl><dt id="n22" class="n2">2号艇</dt><dd><input name="A_04_22" id="A_04_1" class="textbox" type="text" value="{{ old('A_04_22', $mail_magazine->SENSYU_INFO_TOUBAN22) }}" maxlength="4" onBlur="A_WrapChange( 22 )"></dd></dl></li>
                                    <li><dl><dt id="n23" class="n3">3号艇</dt><dd><input name="A_04_23" id="A_04_1" class="textbox" type="text" value="{{ old('A_04_23', $mail_magazine->SENSYU_INFO_TOUBAN23) }}" maxlength="4" onBlur="A_WrapChange( 23 )"></dd></dl></li>
                                    <li><dl><dt id="n24" class="n4">4号艇</dt><dd><input name="A_04_24" id="A_04_1" class="textbox" type="text" value="{{ old('A_04_24', $mail_magazine->SENSYU_INFO_TOUBAN24) }}" maxlength="4" onBlur="A_WrapChange( 24 )"></dd></dl></li>
                                    <li><dl><dt id="n25" class="n5">5号艇</dt><dd><input name="A_04_25" id="A_04_1" class="textbox" type="text" value="{{ old('A_04_25', $mail_magazine->SENSYU_INFO_TOUBAN25) }}" maxlength="4" onBlur="A_WrapChange( 25 )"></dd></dl></li>
                                    <li><dl><dt id="n26" class="n6">6号艇</dt><dd><input name="A_04_26" id="A_04_1" class="textbox" type="text" value="{{ old('A_04_26', $mail_magazine->SENSYU_INFO_TOUBAN26) }}" maxlength="4" onBlur="A_WrapChange( 26 )"></dd></dl></li>
                                    <div class="clear"></div>
                                </ul>
    ...
    <div id="btn_normal"><a href="/asp/tsu/admin/mailmagazine/cms_mail_event.asp?id=2228&mode=1" target="_blank">HP引用</a></div>
                                <div class="box_no"><label>非掲載<input name="A_no2" id="A_no" class="checkbox" value="1" type="checkbox" onClick="B_Disable();"  @if(old('A_no2', $mail_magazine->FAN_EVENT_FLG)) checked @endif ></label></div>
                                <textarea name="B_01" id="B_01" class="textarea" onKeyUp="B_WrapChange();" maxlength="2000">{{ old('B_01', $mail_magazine->FAN_EVENT_TEXT) }}</textarea>
                            </div>
                        </div><!--/box B-->
    ...
    <div id="btn_reload"><a href="javascript:void(0);" onClick="RaceReload();">再読込</a></div>
                                <div class="box_no"><label>非掲載<input name="A_no5" id="A_no" class="checkbox" value="1" type="checkbox" onClick="D_Disable();" @if(old('A_no5', $mail_magazine->NEXT_EXHIBITION_FLG)) checked @endif ></label></div>
                                
                                <dl id="D_01d">
                                    <dt><input name="D_01_1" id="D_01_1" class="textbox" type="text" value="{{ old('D_01_1', $mail_magazine->NEXT_EXHIBITION_DATE1) }}" maxlength="18" onKeyUp="D_WrapChange();"></dt>
                                    <dd><input name="D_01_2" id="D_01_2" class="textbox" type="text" value="{{ old('D_01_2', $mail_magazine->NEXT_EXHIBITION1) }}" maxlength="128" onKeyUp="D_WrapChange();"></dd>
                                    <dt><input name="D_02_1" id="D_02_1" class="textbox" type="text" value="{{ old('D_02_1', $mail_magazine->NEXT_EXHIBITION_DATE2) }}" maxlength="18" onKeyUp="D_WrapChange();"></dt>
                                    <dd><input name="D_02_2" id="D_02_2" class="textbox" type="text" value="{{ old('D_02_2', $mail_magazine->NEXT_EXHIBITION2) }}" maxlength="128" onKeyUp="D_WrapChange();"></dd>
                                    <dt><input name="D_03_1" id="D_03_1" class="textbox" type="text" value="{{ old('D_03_1', $mail_magazine->NEXT_EXHIBITION_DATE3) }}" maxlength="18" onKeyUp="D_WrapChange();"></dt>
                                    <dd><input name="D_03_2" id="D_03_2" class="textbox" type="text" value="{{ old('D_03_2', $mail_magazine->NEXT_EXHIBITION3) }}" maxlength="128" onKeyUp="D_WrapChange();"></dd>
                                    <div class="clear"></div>
                                </dl>
                            </div>
                        </div><!--/box D-->
    ...
    <div id="btn_normal"><a href="/asp/tsu/admin/mailmagazine/cms_mail_event.asp?id=2228&mode=2" target="_blank">HP引用</a></div>
                                <div class="box_no"><label>非掲載<input name="A_no6" id="A_no" class="checkbox" value="1" type="checkbox" onClick="E_Disable();"  @if(old('A_no6', $mail_magazine->FREE_FLG)) checked @endif></label></div>
                                
                                <textarea name="E_01" id="E_01" class="textarea" maxlength="2000" onKeyUp="E_WrapChange();">{{ old('E_01', $mail_magazine->FREE_TEXT) }}</textarea>
                            </div>
                        </div><!--/box E-->
            ...
            <div id="name">
                <dl>
                <dt>作業者名</dt>
                <dd><input name="name" id="name" class="textbox" type="text" maxlength="16" value="{{ old('name', $mail_magazine->EDIT_NAME) }}"></dd>
                <div class="clear"></div>
                </dl>
...
@section('script')
    ...
    function RaceReload(){
        document.MailForm.D_01_1.value='{{ old('D_01_1', $mail_magazine->NEXT_EXHIBITION_DATE1) }}';
        document.MailForm.D_01_2.value='{{ old('D_01_2', $mail_magazine->NEXT_EXHIBITION1) }}';
        document.MailForm.D_02_1.value='{{ old('D_02_1', $mail_magazine->NEXT_EXHIBITION_DATE2) }}';
        document.MailForm.D_02_2.value='{{ old('D_02_2', $mail_magazine->NEXT_EXHIBITION2) }}';
        document.MailForm.D_03_1.value='{{ old('D_03_1', $mail_magazine->NEXT_EXHIBITION_DATE3) }}';
        document.MailForm.D_03_2.value='{{ old('D_03_2', $mail_magazine->NEXT_EXHIBITION3) }}';
        D_WrapChange();
    }
    function SesnyuReload(){
        document.MailForm.A_021.value = '{{ old('A_021', $mail_magazine->SENSYU_INFO_TEXT1) }}';
        document.MailForm.A_04_11.value = '{{ old('A_04_11', $mail_magazine->SENSYU_INFO_TOUBAN11) }}';
        document.MailForm.A_04_12.value = '{{ old('A_04_12', $mail_magazine->SENSYU_INFO_TOUBAN12) }}';
        document.MailForm.A_04_13.value = '{{ old('A_04_13', $mail_magazine->SENSYU_INFO_TOUBAN13) }}';
        document.MailForm.A_04_14.value = '{{ old('A_04_14', $mail_magazine->SENSYU_INFO_TOUBAN14) }}';
        document.MailForm.A_04_15.value = '{{ old('A_04_15', $mail_magazine->SENSYU_INFO_TOUBAN15) }}';
        document.MailForm.A_04_16.value = '{{ old('A_04_16', $mail_magazine->SENSYU_INFO_TOUBAN16) }}';
        document.MailForm.A_022.value = '{{ old('A_022', $mail_magazine->SENSYU_INFO_TEXT1) }}';
        document.MailForm.A_04_21.value = '{{ old('A_04_21', $mail_magazine->SENSYU_INFO_TOUBAN21) }}';
        document.MailForm.A_04_22.value = '{{ old('A_04_22', $mail_magazine->SENSYU_INFO_TOUBAN22) }}';
        document.MailForm.A_04_23.value = '{{ old('A_04_23', $mail_magazine->SENSYU_INFO_TOUBAN23) }}';
        document.MailForm.A_04_24.value = '{{ old('A_04_24', $mail_magazine->SENSYU_INFO_TOUBAN24) }}';
        document.MailForm.A_04_25.value = '{{ old('A_04_25', $mail_magazine->SENSYU_INFO_TOUBAN25) }}';
        document.MailForm.A_04_26.value = '{{ old('A_04_26', $mail_magazine->SENSYU_INFO_TOUBAN26) }}';
        A_WrapChange( 0 )
    }
