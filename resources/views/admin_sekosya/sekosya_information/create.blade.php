	...
	<div id="information">
		...
		<div id="msg">
			...
			<div id="msg_r" class="radio">
				<label>
					<input type="radio" name="kubun" value="1" @if(old('kubun') == "1") checked @endif>
					<span>更新</span>
				</label>
				<label>
					<input type="radio" name="kubun" value="2" @if(old('kubun') == "2") checked @endif>
					<span>お知らせ</span>
				</label>
				<label>
					<input type="radio" name="kubun" value="3" @if(old('kubun') == "3") checked @endif>
					<span>重要</span>
				</label>
			</div><!--/#msg_r-->
		...
		<div id="msg">
			...
			<div id="msg_r" class="checkbox">
				<label id="devic01_check" class="c_on"><input type="checkbox" name="devic01" value="1" @if(old('devic01')) checked @endif><span class="pc">PC</span></label>
				<label id="devic02_check" class="c_on"><input type="checkbox" name="devic02" value="1" @if(old('devic02')) checked @endif><span>スマホ</span></label>
				<label id="devic03_check" class="c_on"><input type="checkbox" name="devic03" value="1" @if(old('devic03')) checked @endif><span>ケータイ</span></label>
			</div><!--/#msg_r-->
			<div class="clear"></div>
		</div><!--/#msg-->
		...
		<div id="msg_r">
		<input name="date1" type="text" value="{{ old('date1') }}" size="14" maxlength="12" onblur="javascript:MojiCheck();funcDispDate1(document.InputForm.date1.value,'changedate1',12);" class="fm_date">
		...
		<div id="msg_r">
		<input name="date2" type="text" value="{{ old('date2') }}" size="14" maxlength="12" onblur="javascript:MojiCheck();funcDispDate1(document.InputForm.date2.value,'changedate2',12);" class="fm_date">
		...
		<div id="msg_r">
		<input name="date3" type="text" value="{{ old('date3') }}" size="14" maxlength="8" onblur="MojiCheck();javascript:funcDispDate1(document.InputForm.date3.value,'changedate3',8);" class="fm_date">
		...
		<label id="New_flg_check" class=""><input type="checkbox" name="New_flg" value="1" @if(old('New_flg')) checked @endif><span>表示<span>※デフォルト3日間。</span></span></label>
		</div><!--/#msg_r-->
		...
		<div id="msg_r">
		  ...
		  <input type="text" name="title" maxlength="54" onkeyup="ShowLength(1);" onblur="javascript:funcLinkCheck();" class="title"  value="{{ old('title') }}">
		...
		<label id="head_check_check" class=""><input name="head_check" type="checkbox" value="1" @if(old('head_check')) checked @endif><span>HOT NEWSのみに表示</span></label>
		<input type="text" name="head_ttl_txt" maxlength="54" onkeyup="ShowLength(2);" onblur="javascript:funcLinkCheck();" class="title" value="{{old('head_ttl_txt')}}">
		...
		<span class="midashi pc">PC</span><input name="link_pc" type="text" value="{{ old('link_pc') }}" size="14" maxlength="128" onblur="javascript:funcLinkCheck();" class="title">  <label id="link_pc_check_check" class=""><input name="link_pc_check" type="checkbox" value="1" @if(old('link_pc_check')) checked @endif ><span>別画面フラグ</span></label>
		<span class="midashi">スマホ</span><input name="link_sp" type="text" value="{{ old('link_sp') }}" size="14" maxlength="128" onblur="javascript:funcLinkCheck();" class="title"><label id="link_sp_check_check" class=""><input name="link_sp_check" type="checkbox" value="1" @if(old('link_sp_check')) checked @endif ><span>別画面フラグ</span></label>
		<span class="midashi">ケータイ</span><input name="link_mb" type="text" value="{{ old('link_mb') }}" size="14" maxlength="128" onblur="javascript:funcLinkCheck();" class="title"> <label id="link_mb_check_check" class=""><input name="link_mb_check" type="checkbox" value="1" @if(old('link_mb_check')) checked @endif ><span>別画面フラグ</span></label>
		</div><!--/#msg_r-->
		<div class="clear"></div>
		</div><!--/#msg-->
		...
		<div id="msg_r">
		<textarea rows="18" class="fm_msg" type="text" name="main_txt" maxlength="2000">{!! old('main_txt') !!}</textarea>
		</div><!--/#msg_r-->
		<div class="clear"></div>
		</div><!--/#msg-->
		...
		<input name="date4" type="text" value="{{ old('date4') }}" size="14" maxlength="16">
