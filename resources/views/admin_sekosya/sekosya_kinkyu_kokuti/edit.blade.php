...
<form action="" name="InputForm" method="post" enctype="MultiPart/Form-Data">
	<div id="warapper" style="width: 980px; margin:0 auto;">
		@if($kinkyu_kokuti->APPEAR_FLG)
			@if($kinkyu_kokuti->END_DATE && $kinkyu_kokuti->END_DATE < date("YmdHi"))
				<span id="id_AppearView"><div class="end_tit">公開終了</div></span>
			@else
				@if($kinkyu_kokuti->START_DATE > date("YmdHi"))
		...
		<div id="msg_r">
		<input type="text" name="txtdate1" value="{{ old('txtdate1', $kinkyu_kokuti->START_DATE) }}" class="fm_date" maxlength="12" onBlur="javascript:MojiCheck();funcDispDate1(document.InputForm.txtdate1.value,'date01',12);">
		...
		<div id="msg_r">
		<input type="text" name="txtdate2" value="{{ old('txtdate2', $kinkyu_kokuti->START_DATE) }}" class="fm_date" maxlength="12" onBlur="javascript:MojiCheck();funcDispDate1(document.InputForm.txtdate2.value,'date02',12);">
		...
		<div id="msg_r">
		<input type="text" name="title" value="{{ old('title', $kinkyu_kokuti->TITLE) }}" maxlength="256" class="title">
		</div><!--/#msg_r-->
		<div class="clear"></div>
		</div><!--/#msg-->
		...
		<textarea rows="6" name="honbun" class="fm_msg" type="text" maxlength="1000" >{{ old('honbun', $kinkyu_kokuti->HONBUN) }}</textarea>
		<p>
		...
		<div id="msg_r">
		PC<label id="devic01_check" class="c_on"><input type="checkbox" name="pc_check" value="1"  @if(old('pc_check', $kinkyu_kokuti->PC_FLG)) checked @endif ></label>
		スマホ<label id="devic02_check" class="c_on"><input type="checkbox" name="sp_check" value="1"  @if(old('sp_check', $kinkyu_kokuti->SP_FLG)) checked @endif></label>
		携帯<label id="devic03_check" class="c_on"><input type="checkbox" name="mb_check" value="1"  @if(old('mb_check', $kinkyu_kokuti->MB_FLG)) checked @endif></label>
		</div><!--/#msg_r-->
		<div class="clear"></div>
		</div><!--/#msg-->
		...
		<div id="msg_r">
		<input type="text" name="editor" value="{{ old('editor', $kinkyu_kokuti->EDITOR_NAME) }}" maxlength="32" class="fm_date">
		</div><!--/#msg_r-->
		<div class="clear"></div>
		</div><!--/#msg-->
		...
		<div id="action_c">
		<span class="open_b"><input type="button" onClick="location.href='/admin_sekosya/kinkyu_kokuti/change_appear_flg/{{$kinkyu_kokuti->ID}}/1'" value="公開"></span>
		<span class="close_b"><input type="button" onClick="location.href='/admin_sekosya/kinkyu_kokuti/change_appear_flg/{{$kinkyu_kokuti->ID}}/0'" value="非公開"></span>
		<div class="clear"></div>
		</div><!--/#action_c-->
