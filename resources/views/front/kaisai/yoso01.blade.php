...
<meta http-equiv="Refresh" CONTENT="180; URL=/asp/kyogi/09/pc/yoso01/yoso01{{str_pad($race_num, 2, '0', STR_PAD_LEFT)}}_{{$target_date}}.htm">
<title>レース予想・ツッキーナビ／節間成績</title>
...
@foreach($syussou as $teiban => $item)
    ...
    <tr>
        ...
        <td rowspan="4" class="hyoka1"></td>
        <td rowspan="4" class="hyoka1"></td>
        <td rowspan="4" class="hyoka2"></td>
        <td class="seiseki">R</td>
        @for($race_day_count=1;$race_day_count<=8;$race_day_count++)
            <td class="s_race_8 left">&ensp;</td>
            <td class="s_race_8 right">&ensp;</td>
        @endfor
    ...
    <tr>
        ...
        @for($race_day_count=1;$race_day_count<=8;$race_day_count++)
            <td class="s_sin left">&ensp;</td>
            <td class="s_sin right">&ensp;</td>
        @endfor
        
    </tr>
    <tr>
        <td rowspan="2" colspan="2" class="ST"></td>
        <td rowspan="2" class="rate02"></td>
        <td class="seiseki">ST</td>
        @for($race_day_count=1;$race_day_count<=8;$race_day_count++)
            <td class="s_ST left">&ensp;</td>
            <td class="s_ST right">&ensp;</td>
        @endfor
...
<div id="tsukky_btn">
<ul>
<li class="tsukky_btn_01">節間成績</li>
<li class="tsukky_btn_02on"><a href="/asp/kyogi/09/pc/yoso01st/yoso01st{{str_pad($race_num, 2, '0', STR_PAD_LEFT)}}_{{$target_date}}.htm">スタート展示</a></li>
<div class="clear"></div>
</ul>
</div><!--/#tsukky_btn-->
