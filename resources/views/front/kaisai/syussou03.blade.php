...
<meta http-equiv="Refresh" CONTENT="180; URL=/asp/kyogi/09/pc/syusso03/syusso03{{str_pad($race_num, 2, '0', STR_PAD_LEFT)}}_{{$target_date}}.htm">
<title>出走表・当地過去3節</title>
...
<div id="date_l"><script type="text/javascript">
	func_Backbtn('{{$target_date}}' , 'syusso03' );
</script>
</div><!--/#date_l-->
<div id="date_c">
    @if($kaisai_master)
...
<div id="date_r"><script type="text/javascript">
	func_Nextbtn('{{$target_date}}' , 'syusso03' );
</script>
</div><!--/#date_r-->
<div class="clear"></div>
</div><!--/#date-->
...
func_RaceNumList('{{$target_date}}' , {{$race_num}}, 'syusso03' );
</script>
<div class="clear"></div>
</ul>
</div><!--/#race_btn-->
...
<div id="main_race">
<div id="main_race_l"><a href="/asp/kyogi/09/pc/syusso02/syusso02{{str_pad($race_num, 2, '0', STR_PAD_LEFT)}}_{{$target_date}}.htm">前へ</a></div><!--/#main_race_l-->
...
@foreach($syussou as $teiban => $item)
    @if($ozz_info_array[$teiban] != 2)
        ...
        <tr>
            ...
            @isset($item['touchi_rireki_3'][1])
                <td class="setsu"><div class="{{$general->gradenumber_to_gradename_for_front_syussou($item['touchi_rireki_3'][1]['touchi_grade'])}}"></div>
                    <div class="kikan">{{$general->create_display_date($item['touchi_rireki_3'][1]['touchi_start_date'],$item['touchi_rireki_3'][1]['touchi_end_date'])}}</div>
                </td>
            @else
                <td class="setsu">-</td>
            @endisset
            
            @isset($item['touchi_rireki_3'][2])
                <td class="setsu"><div class="{{$general->gradenumber_to_gradename_for_front_syussou($item['touchi_rireki_3'][2]['touchi_grade'])}}"></div>
                    <div class="kikan">{{$general->create_display_date($item['touchi_rireki_3'][2]['touchi_start_date'],$item['touchi_rireki_3'][2]['touchi_end_date'])}}</div>
                </td>
            @else
                <td class="setsu">-</td>
            @endisset

            @isset($item['touchi_rireki_3'][3])
                <td class="setsu"><div class="{{$general->gradenumber_to_gradename_for_front_syussou($item['touchi_rireki_3'][3]['touchi_grade'])}}"></div>
                    <div class="kikan">{{$general->create_display_date($item['touchi_rireki_3'][3]['touchi_start_date'],$item['touchi_rireki_3'][3]['touchi_end_date'])}}</div>
                </td>
            @else
                <td class="setsu">-</td>
            @endisset
        ...
        <tr>
            ...
            @isset($item['touchi_rireki_3'][1])
                <td class="kekka">{!! $item['touchi_rireki_3'][1]['touchi_tyakujun'] !!}</td>
            @else
                <td class="kekka"> </td>
            @endisset

            @isset($item['touchi_rireki_3'][2])
                <td class="kekka">{!! $item['touchi_rireki_3'][2]['touchi_tyakujun'] !!}</td>
            @else
                <td class="kekka"> </td>
            @endisset

            @isset($item['touchi_rireki_3'][3])
                <td class="kekka">{!! $item['touchi_rireki_3'][3]['touchi_tyakujun'] !!}</td>
            @else
                <td class="kekka"> </td>
            @endisset
        </tr>
...
<div id="main_race_r"><a href="/asp/kyogi/09/pc/syusso04/syusso04{{str_pad($race_num, 2, '0', STR_PAD_LEFT)}}_{{$target_date}}.htm">次へ</a></div><!--/#main_race_r-->
<div class="clear"></div>
</div><!--/#main_race-->
