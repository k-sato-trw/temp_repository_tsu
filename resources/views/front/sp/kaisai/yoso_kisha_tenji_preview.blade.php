                    ...
                    @endif
                        ...
                        <tr>
                            <td colspan="5" class="ozz">
                                @isset($bairitu_3rentan[substr($strAryTempData[$intLoopCount2],0,1)][substr($strAryTempData[$intLoopCount2],1,1)][substr($strAryTempData[$intLoopCount2],2,1)])
                                {{$bairitu_3rentan[substr($strAryTempData[$intLoopCount2],0,1)][substr($strAryTempData[$intLoopCount2],1,1)][substr($strAryTempData[$intLoopCount2],2,1)]}}
                                @endisset
                            </td>
                        </tr>
                    </table>
